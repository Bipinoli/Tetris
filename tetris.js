...
let dropCounter = 0;
const dropInterval = 1000; // 1000 ms = 1 s
...
function playerReset() {
	const pieces = "SZIOLJT";
	player.matrix = createPiece(pieces[pieces.length * Math.random() | 0]); // | 0 for floor operation
	player.pos.y = 0;
